...
const todoInput = document.getElementById("todo-input"); // Korrigiert
const todoListUL = document.getElementById("todo-list"); // Korrigiert
...
function updateTodoList() {
  ...
  allTodos.forEach((todo, todoIndex) => {
    let todoItem = createTodoItem(todo, todoIndex); // Korrigiert
...
<input type="checkbox" id="${todoId}">
            ...
            <label for="${todoId}" class="todo-text">${todo.text}</label> <!-- Korrigiert -->
...
`;
    ...
    deleteButton.addEventListener("click", () => deleteTodoItem(todoIndex)); // Korrigiert
